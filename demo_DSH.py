...
from Discrete_hashing_methods import DSH
...
#%% spectral hashing (used as initialization of DSH)
#F = spectral_hashing(Z, K=K, thresholding=None)

#%% Learning binary codes
B = DSH(Z, K=K, n_iter=30, Ng_iter=30, random_state=random_state, F=None, verbose=1)
