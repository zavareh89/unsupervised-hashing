...
from evaluate import Macro_AP, return_all_metrics
from out_of_sample import KSH_binary_codes
from SH import kernel_spectral_hashing

#%% parameter initialization
method_name = 'KSH' 
kernel_metric = 'rbf' # the kernel function used in KSH method 
# kernel_metric = 'linear'
path = r'sun397' # folder containing dataset
dataset_name = 'sun397'
K = 16 # number of bits
...
B, A, b = kernel_spectral_hashing(train_features, Z, anchors, K=K,
                                  metric=kernel_metric)

#%% Generate binary codes 
test_codes = KSH_binary_codes(test_features, anchors, A, b, metric=kernel_metric)
