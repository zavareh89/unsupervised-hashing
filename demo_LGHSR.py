...
from Discrete_hashing_methods import SHSR
...
B, F, Q = SHSR(Z, K=K, n_iter=20, random_state=random_state, verbose=1)
...
test_codes = out_of_sample_binary_codes(test_features, F@Q, Z, anchors, Z_spec)
