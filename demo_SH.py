...
B = spectral_hashing(Z, K=K, thresholding='sign')

#%% # learning hash functions (here, they are linear functions)
# W = RRC(train_features, B, lambda_=1e-2)

# ## compute binary codes for train and test features using linear hash functions
# train_codes = np.sign(train_features@W)
# test_codes = np.sign(test_features@W)
